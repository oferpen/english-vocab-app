      ...
      <div className="bg-white rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] p-10 md:p-14 max-w-md w-full text-center relative z-10 border border-neutral-100">
        ...
        <div className="space-y-6">
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-4 py-5 px-6 border border-neutral-200 rounded-2xl hover:border-indigo-300 hover:bg-indigo-50 transition-all duration-300 transform group active:scale-[0.98] bg-white shadow-[0_8px_20px_-10px_rgba(0,0,0,0.1)] hover:shadow-[0_12px_25px_-10px_rgba(0,0,0,0.15)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 border-4 border-indigo-600 border-t-transparent rounded-full animate-spin"></div>
                <span className="text-lg font-black text-neutral-700">מתחבר...</span>
              </div>
            ) : (
              <>
                ...
                <span className="text-xl font-black text-neutral-700">התחבר עם Google</span>
              </>
            )}
          </button>
